...
docs = {
    ...
    "calculations_long_wire_design.md": (
...
for filename, (title, lines) in docs.items():
    ...
    content = [f"# {title}", "", f"Date: {date.today().isoformat()}", ""]
